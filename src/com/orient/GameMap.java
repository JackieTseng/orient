...
public class GameMap extends Activity implements Runnable{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Log.i("cab","in game gva points --->  "+ gva.points.size());
...
//		myposOverlay.addItem(myposItem);
		...
		for(int i=0;i<missionList.size();++i){
			if(i!=0){
				...
				Log.i("cab", "mission i: "+i+" la "+missionList.get(i).getLatitudeE6()+" lo "+missionList.get(i).getLongitudeE6());
			}else {
